                ...
                {socialBars.map(({ id, child, href, style, download }) => {
                    return (
                        <li
                            key={id}
                            className={
                                `flex justify-between items-center h-14 px-4 w-40 ml-[-100px] transition-all duration-500 ease-in-out hover:ml-[-10px] hover:border-l-0 hover:rounded-md bg-gray-500 ${style}`
                            }
                        >
                            <a
                                href={href}
