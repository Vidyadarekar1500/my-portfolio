...
const Experience = () => {
  return (
    <div
      name="experience"
      className="relative bg-gradient-to-b from-black to-gray-800 py-16 px-4 text-white p-4 w-full md:h-screen"
    >
        ...
        <div className="max-w-6xl mx-auto relative">
          ...
          {timelineData.map((item, idx) => {
            ...
            return (
              <div
                key={idx}
                className="mb-16 flex flex-col md:flex-row items-center relative"
              >
                {/* Content */}
                <div
                ...
                >
                  ...
                  <p
                    className={`mt-2 text-sm text-slate-400 italic ${
